...
describe('Validation utilities', () => {
	...
	describe('validateName', () => {
		/**
		 * Property: Names longer than 100 characters (after trimming) should be rejected
		...
		/**
		 * Property: Names with 100 or fewer characters (after trimming) should be accepted
		 * **Validates: Requirements 6.3**
		 */
